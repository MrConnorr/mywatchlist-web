...
function CommentsAdding(props)
{
    ...
    const url = isReplyClicked ? `https://mywatchlistapi.onrender.com/comments/${mediaType}/${watchObjId}/${commentId}` : `https://mywatchlistapi.onrender.com/comments/${mediaType}/${watchObjId}`;
